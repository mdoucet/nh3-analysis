...
data_dir = '/SNS/REF_L/IPTS-30384/shared/dynamic/Cu-B'
...
initial_data_file = os.path.join(ar_dir, 'REFL_207012_combined_data_auto.txt')
initial_data = np.loadtxt(initial_data_file).T

final_data_file = os.path.join(ar_dir, 'REFL_207020_combined_data_auto.txt')
final_data = np.loadtxt(initial_data_file).T

initial_err_file = os.path.join(dyn_model_dir, '207012', '__model-err.json')
initial_expt_file = os.path.join(dyn_model_dir, '207012', '__model-expt.json')

final_err_file = os.path.join(dyn_model_dir, '207020', '__model-err.json')
final_expt_file = os.path.join(dyn_model_dir, '207020', '__model-expt.json')
...
loop = fitting_loop.FittingLoop(dyn_data_dir, results_dir=results_dir, model_dir=project_dir, model_name='model-loop-207019',
