...
expt.sample['Plated'].thickness.range(25.0, 50.0)


expt.sample['Plated'].material.rho.range(-1.0, 3.5) # Cu-K was 4.0
#expt.sample['material'].material.irho.range(0.0, 0.3)
expt.sample['Plated'].interface.range(1.0, 25.0)
#expt.sample['material'].interface.range(5, expt.sample['material'].thickness.value/2+5)


expt.sample['SEI'].thickness.range(55.0, 500.0)
...
neigh_thick = min(expt.sample['Plated'].thickness.value, expt.sample['SEI'].thickness.value)
