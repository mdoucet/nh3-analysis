...
data_dir = '/SNS/REF_L/IPTS-30384/shared/dynamic/Cu-F/30s'
...
initial_err_file = os.path.join(project_dir, 'dyn-fitting', '207161', '__model-err.json')
initial_expt_file = os.path.join(project_dir, 'dyn-fitting', '207161', '__model-expt.json')

final_err_file = os.path.join(dyn_model_dir, 'REFL_207169-err.json')
final_expt_file = os.path.join(dyn_model_dir, 'REFL_207169-expt.json')
