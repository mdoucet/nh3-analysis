...
initial_err_file = os.path.join(dyn_model_dir, '207268-2layers-err.json')
initial_expt_file = os.path.join(dyn_model_dir, '207268-2layers-expt.json')

final_err_file = os.path.join(dyn_model_dir, '207282-err.json')
final_expt_file = os.path.join(dyn_model_dir, '207282-expt.json')

dynamic_run = 207275
store_basename = os.path.join(dyn_model_dir, '%s-dyn/results-30s-bck-v2' % dynamic_run)
