...
#expt.sample['material'].thickness.range(25.0, 100.0)
expt.sample['material'].material.rho.range(-1.0, 3.5)
#expt.sample['material'].interface.range(5, 25)

expt.sample['THF'].interface.range(10.0, 50.0)
