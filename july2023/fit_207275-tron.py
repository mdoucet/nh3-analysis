...
data_dir = '/SNS/REF_L/IPTS-30384/shared/dynamic/Cu-K/30s'
...
initial_err_file = os.path.join(project_dir, 'dyn-fitting', '207268', '__model-err.json')
initial_expt_file = os.path.join(project_dir, 'dyn-fitting', '207268', '__model-expt.json')

final_err_file = os.path.join(dyn_model_dir, 'REFL_207282-err.json')
final_expt_file = os.path.join(dyn_model_dir, 'REFL_207282-expt.json')
...
loop = fitting_loop.FittingLoop(data_dir, results_dir=results_dir, model_dir=project_dir, model_name='model-loop-207275',
